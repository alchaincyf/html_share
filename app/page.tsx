      ...
      <div className="container mx-auto max-w-7xl px-6 pt-24 pb-12 sm:pt-32 lg:px-8">
        ...
        >
          <motion.div 
            ...
            className="inline-block rounded-full bg-indigo-50 px-3 py-1 text-sm font-semibold text-indigo-600 ring-1 ring-inset ring-indigo-500/20 mb-6"
          >
            全新体验
          </motion.div>
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            ...
            <motion.span 
              ...
              className="text-2xl sm:text-4xl mt-2 block"
            >
              <TypedText 
                strings={[
                  "HTML创作与即时分享平台", 
                ...
                >
                  <dt className="flex items-center gap-x-3 text-lg font-semibold leading-7 text-gray-900">
                    <motion.div 
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-full bg-indigo-100 text-indigo-600"
                    >
